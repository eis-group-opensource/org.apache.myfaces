 ...
 * @version $Revision: 706431 $ $Date: 2008-10-21 01:24:19 +0300 (An, 21 Spl 2008) $
 */
...
//        context.append("}");
    ...
    {
        return contentType.indexOf(TEXT_CSS) != -1;
    }
    ...
    public static String[] getSupportedContentTypes()
    {
        String[] supportedContentTypeArray = new String[]{HTML_CONTENT_TYPE,TEXT_ANY_CONTENT_TYPE,ANY_CONTENT_TYPE,
                                                          XHTML_CONTENT_TYPE,APPLICATION_XML_CONTENT_TYPE,TEXT_XML_CONTENT_TYPE,TEXT_CSS};
